    ...
    <div class="grid lg:grid-cols-4 md:grid-cols-2">
      ...
      <div class="mb-6" id="our-badges">
        ...
        <div class="grid grid-cols-2 gap-2">
          <div><img class="badges" src="<?php echo get_template_directory_uri() . '/img/Software-Development.webp' ?>" alt="Company Name" /></div>
          <div><img class="badges" src="<?php echo get_template_directory_uri() . '/img/Web-Development.webp' ?>" alt="Company Name" /></div>
        </div>
        <div class="grid grid-cols-1">
          <div><img class="badges" src="<?php echo get_template_directory_uri() . '/img/TruefirmReviews.webp' ?>" alt="Company Name" /></div>
        </div>
        <div class="grid grid-cols-1">
          <div><img class="badges" src="<?php echo get_template_directory_uri() . '/img/CrowedReviews.webp' ?>" alt="Company Name" /></div>
        </div>
      </div>
    </div>
  </div>
